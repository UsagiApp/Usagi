...
class DownloadNotificationFactory
	...
	constructor(
		...
		init {
			...
			builder.foregroundServiceBehavior =
				if (isSilent) {
		...
		private fun createChannels() {
			...
			manager.createNotificationChannel(
				NotificationChannelCompat
					.Builder(CHANNEL_ID_DEFAULT, NotificationManagerCompat.IMPORTANCE_LOW)
			...
			manager.createNotificationChannel(
				NotificationChannelCompat
					.Builder(CHANNEL_ID_SILENT, NotificationManagerCompat.IMPORTANCE_MIN)
