...
fun categoryAD(clickListener: FavouriteCategoriesListListener) =
	adapterDelegateViewBinding<CategoryListModel, ListModel, ItemCategoryBinding>(
		...
		val eventListener =
			object : OnClickListener, OnLongClickListener, OnTouchListener {
				override fun onClick(v: View) =
					if (v.id == R.id.imageView_edit) {
...
fun allCategoriesAD(clickListener: FavouriteCategoriesListListener) =
