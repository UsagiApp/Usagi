	...
	constructor(
		...
		override suspend fun getForegroundInfo(): ForegroundInfo {
			...
			val channel =
				NotificationChannelCompat
					.Builder(WORKER_CHANNEL_ID, NotificationManagerCompat.IMPORTANCE_LOW)
					.setName(title)
					.setShowBadge(true)
			...
			val notification =
				NotificationCompat
					.Builder(applicationContext, WORKER_CHANNEL_ID)
		...
		private suspend fun getList(
			...
			runCatchingCancellable {
				...
				val tag =
					tags.firstNotNullOfOrNull { title ->
		...
		private suspend fun showNotification(manga: Manga) {
			val channel =
				NotificationChannelCompat
					.Builder(MANGA_CHANNEL_ID, NotificationManagerCompat.IMPORTANCE_DEFAULT)
		...
		private fun Iterable<String>.inexactIndexOf(
			element: String,
			threshold: Float,
		): Int {
			forEachIndexed { i, t ->
		...
		class Scheduler
			...
			constructor(
				...
				override suspend fun schedule() {
					val request =
						PeriodicWorkRequestBuilder<SuggestionsWorker>(6, TimeUnit.HOURS)
