...
class SettingsSearchFragment :
	...
	override fun onCreateViewBinding(
		...
		container: ViewGroup?,
	): FragmentSearchSuggestionBinding = FragmentSearchSuggestionBinding.inflate(inflater, container, false)

	override fun onViewBindingCreated(
		binding: FragmentSearchSuggestionBinding,
		savedInstanceState: Bundle?,
	) {
		super.onViewBindingCreated(binding, savedInstanceState)
		val adapter =
			BaseListAdapter<SettingsItem>()
	...
	override fun onItemClick(
		item: SettingsItem,
		view: View,
	) = viewModel.navigateToPreference(item)
