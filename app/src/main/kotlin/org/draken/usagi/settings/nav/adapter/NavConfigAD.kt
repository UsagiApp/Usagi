...
fun navConfigAD(clickListener: OnListItemClickListener<NavItem>) =
	adapterDelegateViewBinding<NavItemConfigModel, ListModel, ItemNavConfigBinding>(
		...
		val eventListener =
			object : View.OnClickListener, View.OnTouchListener {
...
fun navAvailableAD(clickListener: OnListItemClickListener<NavItem>) =
...
fun navAddAD(clickListener: View.OnClickListener) =
