...
class CommonHeadersInterceptor
	...
	constructor(
		...
		override fun intercept(chain: Chain): Response {
			...
			val source =
				request.tag(MangaSource::class.java)
		...
		private fun Headers.Builder.trySet(
			name: String,
			value: String,
		) = try {
			set(name, value)
		...
		private fun Interceptor.interceptSafe(chain: Chain): Response =
			runCatchingCancellable {
				...
				if (e is IOException || e is Error) {
					...
					throw WrapperIOException(e as Exception)
				}
			}
