...
class BypassTunnel(
	...
	override fun connect(
		...
		timeout: Int,
	) = implSocket.connect(endpoint, timeout)
	...
	override fun setSoLinger(
		...
		implSocket.setSoLinger(on, linger)
	}
